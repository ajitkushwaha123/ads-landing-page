    ...
    <div className="">
      <div className="bg-primary text-white p-0.5 sm:text-[16px] md:text-[1.8rem] text-center w-full">
        ...
        <div className="w-full rounded-md flex md:items-center md:justify-center bg-black/[0.96] antialiased bg-grid-white/[0.02] relative overflow-hidden">
          <SpotlightBackground />
          <div className=" p-4 md:my-16 text-white max-w-7xl  mx-auto relative z-10  w-full pt-12 md:pt-0">
            ...
            <p className="text-[14px] md:text-[28px] text-center py-[20px] text-[#bebebe] font-black">
